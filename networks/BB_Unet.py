...
class Unet(Module):
    ...
    def __init__(self,in_dim = 1,  drop_rate=0.4, bn_momentum=0.1, n_organs = 1):
        ...
        # Bottle neck
        self.bottleneck = DownConv(256, 256, drop_rate, bn_momentum)
...
class BB_Unet(Module):
    ...
    .. seealso::
        ...
        ArXiv link: https://arxiv.org/abs/1505.04597
    """
    def __init__(self, drop_rate=0.4, bn_momentum=0.1, no_grad=False, n_organs = 1, BB_boxes = 1):
...
class BB_Unet_with_hessian_stack(Module):
    """A reference U-Net model.
    .. seealso::
        Ronneberger, O., et al (2015). U-Net: Convolutional
        Networks for Biomedical Image Segmentation
    ...
    """
    def __init__(self, drop_rate=0.4, bn_momentum=0.1, no_grad=False, n_organs = 1, BB_boxes = 1):
        super(BB_Unet_with_hessian_stack, self).__init__()
        if no_grad is True:
            no_grad_state = True
        else:
            no_grad_state = False
...
class BB_Unet_with_hessian_mul_prior(Module):
    """A reference U-Net model.
    .. seealso::
        Ronneberger, O., et al (2015). U-Net: Convolutional
        Networks for Biomedical Image Segmentation
    ...
    """
    def __init__(self, drop_rate=0.4, bn_momentum=0.1, no_grad=False, n_organs = 1, BB_boxes = 1):
        super(BB_Unet_with_hessian_mul_prior, self).__init__()
        if no_grad is True:
            no_grad_state = True
        else:
            no_grad_state = False
